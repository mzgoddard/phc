...
void test_world() {
...

  {
    ...
    ok(world._optimization.ddvt.length == 1, "1 particle in ddvt");
    phlistiterator litr;
    ...
    ok(world._optimization.ddvt.length == 0, "0 particles in ddvt");
    phWorldDump(&world);
  }

  {
    ...
    ok(
      world._optimization.ddvt.length == 2,
      "2 particles in ddvt, %d",
